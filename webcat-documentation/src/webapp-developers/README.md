...
You may find it useful to first understand some concepts outlined in the [Glossary](../concepts.md#glossary) section.

Next, read WEBCAT's [Requirements](./requirements.md).
